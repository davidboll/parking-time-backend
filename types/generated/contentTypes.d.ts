...
export interface ApiNyhetNyhet extends Schema.CollectionType {
  collectionName: 'nyheter';
  info: {
    singularName: 'nyhet';
    pluralName: 'nyheter';
    displayName: 'Nyheter';
